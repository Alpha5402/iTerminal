...
M9.1 已完成 registry，M9.2 已完成 central Router forwarding；下一步必须增加 Session lease/fencing，不能让任意 Worker 消费后新建第二个“同 Session”PTY。
