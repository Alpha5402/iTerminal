...
- [ ] M10.2 authenticated Runtime RPC Actor grant；覆盖 direct daemon、central Router proxy 与 Worker service identity，禁止 request body 自报 Human/capability。
