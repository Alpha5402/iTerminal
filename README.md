...
**M0–M4.1 and the M8.7 local admission/crash/recovery path pass at L2: shared Shell, durable Action Runtime, real stdio MCP, reliable queue-driven PTY dispatch, non-replayable uncertain interactions, bounded delivery backlog, and single-node RabbitMQ/PostgreSQL process recovery.**
